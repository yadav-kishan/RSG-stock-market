...
async function reverseNov27Distributions() {
  console.log('🔍 Finding referral income distributions from Nov 27, 2025...\n');
  console.log('='.repeat(80));
  
  try {
    // Find all referral income transactions from Nov 27, 2025
    const nov27Start = new Date('2025-11-27T00:00:00.000Z');
    const nov27End = new Date('2025-11-27T23:59:59.999Z');
    
    console.log(`\nSearching for distributions between:`);
    console.log(`  Start: ${nov27Start.toISOString()}`);
    console.log(`  End: ${nov27End.toISOString()}\n`);
    ...
    console.log(`Found ${transactionsToReverse.length} referral income transactions from Nov 27\n`);
    ...
    console.log('\n' + '='.repeat(80));
    console.log('\n⚠️  WARNING: This will:');
    console.log('   1. Delete the referral income transactions from Nov 27');
    ...
    console.log('\n🔄 Reversing Nov 27 distributions...\n');
