...
async function reverseNov26Distributions() {
  console.log('🔍 Finding referral income distributions from Nov 26, 2025...\n');
  console.log('='.repeat(80));
  
  try {
    // Find all referral income transactions from Nov 26, 2025
    const nov26Start = new Date('2025-11-26T00:00:00.000Z');
    const nov26End = new Date('2025-11-26T23:59:59.999Z');
    
    console.log(`\nSearching for distributions between:`);
    console.log(`  Start: ${nov26Start.toISOString()}`);
    console.log(`  End: ${nov26End.toISOString()}\n`);
    ...
    console.log(`Found ${transactionsToReverse.length} referral income transactions from Nov 26\n`);
    ...
    console.log('\n' + '='.repeat(80));
    console.log('\n⚠️  WARNING: This will:');
    console.log('   1. Delete the referral income transactions from Nov 26');
    ...
    console.log('\n🔄 Reversing Nov 26 distributions...\n');
